...
export function ImageUploader({ images, setImages, textLabels, mode = "add", defaultImages = [], multiple = true, maxSize = 50 * 1024 * 1024, allowedTypes = [
    ...
    "image/gif",
    "image/svg+xml",
], maxImages = 20, uploadConfig, autoUpload = false, onUploadComplete, onUploadError, theme = "nature", customTheme, showThemeSelector = false, previewSize = "lg", borderRadius = "md", className = "", containerClassName = "max-w-5xl mx-auto mt-10", showImageCount = true, showFileSize = true, showFileName = true, customUploadButton, hideDefaultUploadArea = false, onUploadClick, }) {
    ...
    return (_jsxs("div", { className: `image-uploader ${containerClassName} ${className}`, children: [_jsx("div", { className: "", children: showImageCount && (_jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 text-sm font-medium rounded-md border", style: {
                    ...
                    if (e.key === "Enter" || e.key === " ") {
                        ...
                        handleUploadClick();
                            ...
                            return (_jsxs("div", { className: "relative group aspect-square", style: {
                                    animation: "fadeIn 0.2s ease-out",
                                    animationDelay: `${index * 30}ms`,
                                }, children: [_jsxs("div", { className: "relative w-full h-full overflow-hidden border transition-all duration-200 hover:shadow-md", style: {
                                            borderRadius: radius,
                                            borderColor: t.cardBorder,
                                            backgroundColor: t.cardBg,
